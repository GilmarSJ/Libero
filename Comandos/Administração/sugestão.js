        ...
        channel.send({
            embeds: [
                new Discord.EmbedBuilder()
                    .setDescription(`**📩 SISTEMA DE SUGESTÃO**

                    <:bot_happy:1017546140255789168> Visando melhorar a qualidade de nossos produtos, para atender a demanda de nossos clientes no dia a dia de sua cidade, criamos um canal de sugestões para que vocês possam sugerir coisas novas para a loja!
                    o para enviar uma sugestão para o servidor.`)
                    .setColor('Gold')
